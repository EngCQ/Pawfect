...
class AdminSelectSellerForAppoScreen extends StatefulWidget {
  const AdminSelectSellerForAppoScreen({super.key});

  @override
  SelectSellerAppoScreenState createState() => SelectSellerAppoScreenState();
}

class SelectSellerAppoScreenState extends State<AdminSelectSellerForAppoScreen> {
            ...
            ElevatedButton(
              onPressed: _selectedSeller == null
                  ...
                  : () {
                      Navigator.pushNamed(
                        context,
                        AppRoutes.adminSelectPetForAppoScreen,
