...
class SelectSellerScreen extends StatefulWidget {
  const SelectSellerScreen({super.key});
...
class _SelectSellerScreenState extends State<SelectSellerScreen> {
  ...
  Future<void> _fetchSellers() async {
    ...
    final List<Map<String, String>> loadedSellers =
    ...
    setState(() {
      ...
      filteredSellers =
          sellers; // Initialize filteredSellers with all sellers initially
    });
  }
  ...
  void _onSellerTap(Map<String, String> seller) {
    ...
    //print('Selected Seller UID: ${seller['uid']}'); // Debug statement
  }
            ...
            ElevatedButton(
              onPressed: _selectedSeller == null
                  ...
                  : () {
                      Navigator.pushNamed(
                        context,
                        AppRoutes.adminAddPet,
                        arguments: {'sellerUid': _selectedSeller!['uid']},
                      );
                    },
