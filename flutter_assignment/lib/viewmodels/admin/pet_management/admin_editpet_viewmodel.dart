...
class AdminEditPetViewModel extends ChangeNotifier {
  final String petId;
  ...
  final TextEditingController speciesController = TextEditingController(); // Add this line
  ...
  AdminEditPetViewModel({required this.petId}) {
    fetchPetData();
  }
  ...
  void dispose() {
    ...
    feeController.dispose(); // Add this line
    speciesController.dispose(); // Add this line
    super.dispose();
  }
  ...
  Future<void> fetchPetData() async {
    ...
    if (petData != null) {
      ...
      speciesController.text = petData['species']; // Add this line
    ...
    if (formKey.currentState!.validate()) {
      ...
      try {
        ...
        PetModel updatedPet = PetModel(
          sellerUid: sellerIdController.text, // Assuming sellerUid is already known or can be fetched
          petName: petNameController.text,
          species: speciesController.text, // Add this line
      ...
      logger.w('Form is not valid'); // Use logger instead of print
    }
  }
}
